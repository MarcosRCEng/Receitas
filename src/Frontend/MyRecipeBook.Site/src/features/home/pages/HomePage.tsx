...
export function HomePage() {
  return (
    <main className="w-full space-y-20 py-6 sm:py-10">
      <section className="grid items-center gap-10 lg:grid-cols-[1.05fr_0.95fr]">
        <div className="max-w-2xl">
          <span className="text-sm font-semibold uppercase text-brand-700">MYRECIPEBOOK</span>
        ...
        <div className="rounded-lg border border-orange-100 bg-white p-5 shadow-xl shadow-orange-100/70">
          <div className="rounded-md bg-[#fff7ed] p-5">
            <div className="flex items-center justify-between gap-4 border-b border-orange-100 pb-4">
              ...
              <span className="rounded-md bg-white px-3 py-2 text-sm font-semibold text-brand-700 shadow-sm">12 receitas</span>
            </div>
            <div className="mt-5 space-y-3">
              {['Risoto de legumes', 'Frango ao molho', 'Bolo de cenoura'].map((recipe) => (
                <div key={recipe} className="flex items-center justify-between rounded-md bg-white px-4 py-3 shadow-sm">
                  ...
                  <span className="text-sm text-slate-500">Favorita</span>
                </div>
              ))}
            </div>
      ...
      <section>
        <div className="max-w-2xl">
          <span className="text-sm font-semibold uppercase text-brand-700">Benefícios</span>
      ...
      <section className="rounded-lg bg-slate-950 px-6 py-10 text-white sm:px-10">
